...
const initialState = {
    allGoals: [ 
        ...
        {id: 4, category: 'FAT', title: 'Reduce Fat %', isSelected: false, recommendation: 'Gradual but steady weight loss can have a significant impact on improving blood pressure, cholesterol and blood sugar. Set your goals appropriately and realistically, remembering that weight loss is a bonus, not a metric, to increasing overall health.'},
