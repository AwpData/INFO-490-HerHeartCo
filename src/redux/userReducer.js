// userReducer.js
// 
// All redux reducers used 

import { 
    TOGGLE_BOOLEAN, UPDATE_GOALS, 
    ADD_WATER, ADD_WATER_LOG, DELETE_WATER_LOG, 
    UPDATE_GLUCOSE, ADD_GLUCOSE_LOG, DELETE_GLUCOSE_LOG, 
    ADD_HRV, 
    TOGGLE_EXERCISE, 
    EDIT_SLEEP, 
    UPDATE_BREAKFAST, UPDATE_LUNCH, UPDATE_DINNER } from "./actions";
